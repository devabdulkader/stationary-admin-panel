      ...
      <div className="flex items-center">
        <div className="flex h-full w-auto flex-col items-start justify-center space-y-4 text-nowrap pl-5">
          <p className="font-semibold text-gray-700">
            Total Expense <span className="font-normal"> MVR 343099</span>
          </p>
          <p className="font-semibold text-gray-700">
            Net Profit <span className="font-normal"> MVR 24088</span>
          </p>
          <p className="font-semibold text-gray-700">
            Profit Margin <span className="font-normal"> 25%</span>
          </p>
        </div>
